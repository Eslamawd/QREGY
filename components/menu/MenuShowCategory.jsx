...
const MenuShowCategory = ({ table_id, restaurant_id, user_id, token }) => {
  ...
  return (
    ...
    >
      ...
      {/* Cover Section */}
      <div className="relative w-full h-[340px] md:h-[420px] overflow-hidden rounded-b-[3rem] shadow-2xl">
        <img
        ...
        <div className="relative flex flex-col items-center justify-center h-full text-center px-4">
          ...
          >
            ...
            <img
              src={restaurant.logo}
              alt={restaurant.name}
              className="relative w-32 h-32 md:w-40 md:h-40 rounded-full border-2 border-white shadow-[0_0_25px_rgba(0,0,0,0.4)] object-cover"
            />
          </motion.div>
          ...
          <motion.h1
            ...
            className="text-3xl md:text-5xl font-bold font-cairo text-white drop-shadow-lg"
          >
            {restaurant.name}
          </motion.h1>
          ...
          >
            ...
            <span className="flex items-center gap-2">
              <Phone className="h-5 w-5 text-emerald-400" /> {restaurant.phone}
            </span>
          </motion.div>
        </div>
      </div>
