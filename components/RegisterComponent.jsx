              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    required
                  >
                    <option className="bg-indigo-800" value="+20">
                      🇪🇬 +20
                    </option>
                    <option className="bg-indigo-800" value="+966">
                      🇸🇦 +966
                    </option>
                    <option className="bg-indigo-800" value="+971">
                      🇦🇪 +971
                    </option>
                    <option className="bg-indigo-800" value="+1">
                      🇺🇸 +1
                    </option>
                  </select>
